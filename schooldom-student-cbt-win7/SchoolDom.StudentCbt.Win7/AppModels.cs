...
{
    public class StudentRecord { public string id { get; set; } public string student_id { get; set; } public string full_name { get; set; } public string class_name { get; set; } public string profile_picture { get; set; } }
