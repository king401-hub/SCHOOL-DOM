...
/// the Device License Key -> registers -> Ready to Scan". Reached only from
/// LoginScreen's hidden "Set up as Scanner Terminal" link, never shown to a
/// normal user again once a device is provisioned (main.dart routes
