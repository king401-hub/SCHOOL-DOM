...
class PersonalQuizAttempt(TenantAwareModel):
    ...
    academic_year = models.ForeignKey("academic.AcademicYear", related_name="personal_quiz_attempts", on_delete=models.SET_NULL, null=True, blank=True)
    term = models.ForeignKey("academic.Term", related_name="personal_quiz_attempts", on_delete=models.SET_NULL, null=True, blank=True)
    title = models.CharField(max_length=255)
