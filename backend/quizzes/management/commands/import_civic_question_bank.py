...
DEFAULT_SOURCE = Path(__file__).resolve().parent.parent.parent / "data" / "civic_question_bank.json"
FOLDER_NAME = "Civic Education Personal Quiz Pool"


class Command(BaseCommand):
    help = "Import the bundled Civic Education personal quiz question bank (WAEC style) into a global folder."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"{len(rows)} civic education personal quiz questions {suffix}."))
