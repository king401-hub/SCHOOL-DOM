...
DEFAULT_SOURCE = Path(__file__).resolve().parent.parent.parent / "data" / "physics_question_bank.json"
FOLDER_NAME = "Physics Personal Quiz Pool"


class Command(BaseCommand):
    help = "Import the bundled Physics personal quiz question bank (JAMB/WAEC style) into a global folder."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"{len(rows)} physics personal quiz questions {suffix}."))
