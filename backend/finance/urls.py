...
urlpatterns = [
    ...
    path("admin/bills/<uuid:bill_id>/", views.admin_bill_detail, name="admin_bill_detail"),
    path("admin/bills/<uuid:bill_id>/recipients/", views.admin_bill_recipients, name="admin_bill_recipients"),
    path("admin/bills/<uuid:bill_id>/publish/", views.admin_bill_publish, name="admin_bill_publish"),
    path("admin/bills/<uuid:bill_id>/duplicate/", views.admin_bill_duplicate, name="admin_bill_duplicate"),
    path("admin/bills/<uuid:bill_id>/send/", views.admin_bill_send, name="admin_bill_send"),
    ...
    path("schoolgate/billing-summary/", views.schoolgate_billing_summary, name="schoolgate_billing_summary"),
    path("schoolgate/pay-device/", views.schoolgate_pay_device, name="schoolgate_pay_device"),
    path("schoolgate/pay-termly/", views.schoolgate_pay_termly, name="schoolgate_pay_termly"),
    path("schoolgate/verify-payment/", views.schoolgate_payment_verify, name="schoolgate_payment_verify"),
    path("schoolgate/activate/", views.schoolgate_activate, name="schoolgate_activate"),
    ...
    path("admin/expenses/payslip/<uuid:record_id>/send/", views.admin_expense_payslip_send, name="admin_expense_payslip_send"),
